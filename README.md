...
Одностраничное приложение (SPA) с 6 разделами, переключаемыми по кнопкам:

1. **Статусы 30.10.2025** - Критическое решение и интеграция OTRS
2. **Реализовано** - Текущие возможности HRS
3. **Доработки 2026** - Планируемые улучшения
4. **Другие виды** - 6 видов увольнения и стратегический выбор OTRS vs HRS
5. **Сценарии отпуска** - 5 вариантов реализации
6. **Сравнение** - Сравнительная таблица всех подходов

🌐 **Ссылка на сайт:** https://aleksey341.github.io/V_-/
